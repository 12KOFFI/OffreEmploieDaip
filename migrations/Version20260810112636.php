 ...
 */
final class Version20260810112636 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE entreprise DROP siret, DROP site_web');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE entreprise ADD siret VARCHAR(50) DEFAULT NULL, ADD site_web VARCHAR(255) DEFAULT NULL');

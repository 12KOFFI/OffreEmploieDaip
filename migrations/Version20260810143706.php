 ...
 */
final class Version20260810143706 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE offre DROP date_debut');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE offre ADD date_debut DATETIME DEFAULT NULL');

 ...
 */
final class Version20260810112949 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE offre CHANGE titre titre VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE offre CHANGE titre titre VARCHAR(255) NOT NULL');
